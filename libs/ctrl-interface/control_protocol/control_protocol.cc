...
Signal<void()>       ControlProtocol::ZoomToSession;
Signal<void()>       ControlProtocol::ZoomOut;
Signal<void()>       ControlProtocol::ZoomIn;
Signal<void()>       ControlProtocol::Enter;
Signal<void()>       ControlProtocol::Undo;
Signal<void()>       ControlProtocol::Redo;
Signal<void(float)> ControlProtocol::ScrollTimeline;
Signal<void(uint32_t)> ControlProtocol::GotoView;
Signal<void()> ControlProtocol::CloseDialog;
